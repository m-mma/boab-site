...
class Wedding_Paypal_Pro
{
	...
	function wedding_paypal_pro_call($methodName,$nvpStr)
	{
		$ch = curl_init();
		...
		$nvpResArray=$this->wedding_paypal_pro_deformat($response);
		$nvpReqArray=$this->wedding_paypal_pro_deformat($nvpreq);
	...
	function wedding_paypal_pro_deformat($nvpstr)
	{
