	...
	<div id="item_results">
		...
		?>
            <div class="col-md-12 vendor-listing">
              <h2><?php printf( esc_html__( 'Total %s items in your search', 'weddingvendor' ),  esc_html($total_element) ); ?></h2>
            </div>
        <?php 		
        ...
        <div class="grid">
		  ...
		  <?php 
            ...
            <figcaption>
              ...
              <p><?php esc_html($item_address);?></p>
              <a href="<?php the_permalink(); ?>"><?php esc_html_e('View more','weddingvendor');?></a> </figcaption>
          </figure>
        </div>
      </div>
		<?php 		
