...
<div class="filter-box" id="searchform">
  <div class="container-fluid">
    <div class="row filter-form">
      <div class="col-md-12">
        <h4><?php esc_html_e('Refine Your Search','weddingvendor');?></h4>
      </div>
      <form method="get">
      	<div class="col-md-12">
          ...
          <div class="row">
            ...
            ?>
                <div class="col-md-12 vendor-listing">
                  <h2><?php  printf( esc_html__( 'Total %s items in your search', 'weddingvendor' ),  esc_html(count($item->posts)) );?></h2>
                </div>
            </div>      
            <div class="row">   
            <?php         
            ...
            <div class="<?php echo $col_class;?> vendor-box"><!-- venue box start-->
              <div class="vendor-image"><!-- venue pic --> 
                ...
                <a href="<?php echo get_category_link($itemcategory[0]->term_id); ?>" class="label-primary"><?php echo $itemcategory[0]->name;?></a>      			<?php echo wedding_wishlist_item_html($post->ID); ?>
              </div>
              <!-- /.venue pic -->
